 ...
 */
@Config
public class UGMap extends MecanumDrive {
    ...
    public DcMotorEx leftFront, leftRear, rightRear, rightFront, shooter1,shooter2, intakemotor, forklift;
    ...
    public UGMap(HardwareMap hardwareMap) {
        ...
        forklift = hardwareMap.get(DcMotorEx.class, "Forklift Motor");
