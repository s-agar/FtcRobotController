        ...
        if (rgbImage != null) {
            ...
            if (red) {
                if (!useBlueCamera) {
                    ...
                    cropWidth = (int) ((90.0 / 640.0) * bitmap.getWidth());
                    cropHeight = (int) ((50.0 / 480.0) * bitmap.getHeight());
                }
            }
            else {
                if (!useBlueCamera) {
                    ...
                    cropStartX = (int) ((355.0 / 640.0) * bitmap.getWidth());
                    cropStartY = (int) ((260.0 / 480.0) * bitmap.getHeight());
