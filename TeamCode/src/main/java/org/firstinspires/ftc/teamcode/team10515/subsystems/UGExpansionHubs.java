...
public class UGExpansionHubs implements ISubsystem {
    private UGAutoRobot autorobot;
    ...
    public UGExpansionHubs(UGAutoRobot autorobot, ExpansionHubEx masterHub, ExpansionHubEx slaveHub) {
        setRobot(autorobot);
    ...
    public UGAutoRobot getRobot() { return autorobot;  }
    public void setRobot(UGAutoRobot robot) { this.autorobot = robot; }
