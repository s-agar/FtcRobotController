...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(9, 0, 1);//18,0,1
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(14, 0, 1);//20,0,0
